...
const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      period: "2020 - 2022",
      description:
        "Led front-end delivery across multiple client projects, building accessible, responsive UIs with React and TypeScript.",
      achievements: [
        "Implemented reusable components and design systems",
        "Optimized Web Vitals and Lighthouse scores",
        "Built complex interactions with Tailwind and Framer Motion",
        "Collaborated with designers to translate Figma to production",
      ],
      technologies: [
        "React",
        "TypeScript",
    ...
    },
    {
      ...
      period: "2019 - 2020",
      description:
        "Contributed to front-end features in a fast-paced startup, learning modern React patterns and performance best practices.",
      achievements: [
        "Developed UI components and pages with React and JavaScript",
        "Improved accessibility and responsiveness across devices",
        "Participated in code reviews and front-end best practices",
        "Assisted with testing using React Testing Library and Jest",
      ],
      technologies: [
        "JavaScript",
        "React",
